...
#'
#' @return A `data.frame` with the selected series.If `trim = TRUE`, leading and trailing all-NA rows are removed.
#'  If a single series is selected, returns a single-column data frame.
#'
#' @examples
...
#'
#' @export
trs_select <- function(x, series, trim = FALSE) {
