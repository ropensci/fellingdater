...
![Fig. 1: A cross-section of a historical timber from a medieval roof construction. All ring boundaries are marked, as well as the heartwood and the partially preserved sapwood.](cross-section.png){#fig-cross-section}
...
![Fig. 2: A generalized workflow and related functions, for inferring felling dates from tree-ring dated historical timbers.](workflow.png){#fig-workflow}
...
![Fig. 3: Two sapwood datasets with a density function modeled to the raw data.](sw_model_plot.jpg){#fig-sw-model}
...
![Fig. 4: A truncated lognormal distribution, representing the sapwood model for a tree-ring series with 10 sapwood rings. The black line delineates the 95% credible interval for the felling date.](sw_interval.jpg){#fig-sw-interval align="center" width="100%"}
