...
testthat::test_that("cred_mass must be between 0 and 1", {
     testthat::expect_error(
          fd_report(sw_example4,
               "cred_mass" = "lots"
          ),
          regexp = "cred_mass"
     )
     testthat::expect_error(
          fd_report(sw_example5,
               "cred_mass" = -145
          ),
          regexp = "cred_mass"
     )
     testthat::expect_error(
          fd_report(sw_example6,
               "cred_mass" = 1.01
          ),
          regexp = "cred_mass"
     )
