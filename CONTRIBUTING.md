...
This outlines how to propose a change to fellingdater. For more detailed
info about contributing, please see the [**development contributing
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/fellingdater", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://ropensci.github.io/fellingdater/CODE_OF_CONDUCT.md). By
