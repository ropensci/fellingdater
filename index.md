...
![](reference/figures/cross-section.png)
...
- **Data generation and preparation**: Create synthetic datasets with
  ...
  or read and prepare real data with
...
- **Crossdating analysis**: Perform crossdating with
  ...
  - *t*-values according to [Hollstein
    ...
    procedures
    ([`trs_tho()`](https://ropensci.github.io/fellingdater/reference/trs_tho.md)and
...
![](reference/figures/README-model_sapwood_counts-1.png)
...
![](reference/figures/README-trs-example-1.png)
