...
> Kristof HANECA [![](./figures/ORCHiD.png)](https://orcid.org/0000-0002-7719-8305), Vincent DEBONNE, Patrick HOFFSUMMER, (under review). `r title`. _Dendrochronologia_.
...
sw2 <- sapwood_PDF(swr = 0, last = 1234, model = "Wazny_1990")
...
The `sapwood_combine()`-function takes 5 arguments:
