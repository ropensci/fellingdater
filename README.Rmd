...
This package and and functions were developed during the analysis of a large data set of tree-ring series that originate from medieval timber constructions in the town of [Bruges](https://en.wikipedia.org/wiki/Bruges) (Belgium). The results of this study are presented in a paper published in [_Dendrochronologia_](https://www.journals.elsevier.com/dendrochronologia).
