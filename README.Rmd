...
An overview of the main functions and datasets included within the package can be found here <getting_started>.
Some examples are provided in the 'getting started' vignette.
