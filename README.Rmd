...
An overview of the main functions and sapwood datasets included within the package can be found [here](https://hanecakr.github.io/fellingdateR/reference/).

Some examples are provided in the [`getting started`](https://hanecakr.github.io/fellingdateR/articles/getting_started.html) vignette.
